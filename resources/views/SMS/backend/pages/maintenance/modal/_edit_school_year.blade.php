<div class="modal fade" id="edit{{ $sy->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.maintenance.update', ['table' => 'sy', 'id' => $sy->id]) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <select name="is_active" id="is_active" class="form-control">
                                ...
                                <option value="1" @if ($sy->is_active == true) selected @endif>Yes</option>
                                <option value="0" @if ($sy->is_active == false) selected @endif>No</option>
                            </select>
                            @error('is_active')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
